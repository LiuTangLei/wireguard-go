...
import (
	...
	asmAEAD "github.com/LiuTangLei/wireguard-go/tsasm/amd64/chacha20poly1305"
)
...
func testAEADDispatchHelper(t *testing.T) {
	...
	isAsm := typ.PkgPath() == "github.com/LiuTangLei/wireguard-go/tsasm/amd64/chacha20poly1305"
	if isAsm != wantAsm {
