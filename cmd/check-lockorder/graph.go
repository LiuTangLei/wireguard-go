...
//
//	"(*github.com/LiuTangLei/wireguard-go/device.Device).SetPrivateKey" → "(*Device).SetPrivateKey"
//	"(github.com/LiuTangLei/wireguard-go/device.Peer).Foo"              → "(Peer).Foo"
//	"github.com/LiuTangLei/wireguard-go/device.SomeFunc"                → "SomeFunc"
